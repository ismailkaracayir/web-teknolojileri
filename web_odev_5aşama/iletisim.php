        ...
        <input type="email" class="form-control"  name="email" placeholder="" id="email">
            ...
            <div class="form-group  m-3 ">
                ...
                <div class="form-group  m-3 ">
                    ...
                    <div class="form-group  m-3 ">
                        <input id="btn" onclick="formKontrol()"  style="width: 100px;" class="btn btn-primary" type="submit" name="submit" value="Submit">
                        <input style="width: 100px;" class="btn btn-primary" type="reset" value="Reset">
